# Consuming Professional Tutoring Design System in Expo apps

Read `artifacts/pt-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/pt-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/pt-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/pt-design-system/lib/native-theme";
import { useColors } from "@workspace/pt-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/pt-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/pt-design-system/components/native/badge";
import { Button } from "@workspace/pt-design-system/components/native/button";
import { Card } from "@workspace/pt-design-system/components/native/card";
```
...
Import and render
`@workspace/pt-design-system/components/native/button`, then run Expo
