# Migrating Expo UI to Professional Tutoring Design System

Read `artifacts/pt-design-system/docs/AGENTS.md` and
`artifacts/pt-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/pt-design-system/lib/native-theme` and
  `@workspace/pt-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/pt-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/pt-design-system` and retains only
