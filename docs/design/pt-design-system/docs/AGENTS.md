# Professional Tutoring Design System design system
...
workspace package (`@workspace/pt-design-system`): other artifacts depend
...
`@workspace/pt-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/pt-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/pt-design-system` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/pt-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/pt-design-system/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/pt-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/pt-design-system/docs/migrating-expo.md`
