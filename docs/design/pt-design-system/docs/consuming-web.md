# Consuming Professional Tutoring Design System in web apps

Read `artifacts/pt-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/pt-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/pt-design-system/styles.css";
```
...
`node_modules/@workspace/pt-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/pt-design-system/components/ui/button";
import { cn } from "@workspace/pt-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/pt-design-system/hooks/use-toast";
```
...
`@workspace/pt-design-system/components/ui/button`. Run the app's typecheck
