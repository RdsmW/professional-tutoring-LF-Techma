# Migrating web UI to Professional Tutoring Design System

Read `artifacts/pt-design-system/docs/AGENTS.md` and
`artifacts/pt-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/pt-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/pt-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/pt-design-system/hooks/use-toast`
